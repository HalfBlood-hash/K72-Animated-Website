...
export default function Navbar() {
  ...
  console.log("navbar me ", navOpen);
  return (
    <>
      <div className='navbar z-10 fixed top-0 w-full  flex items-start justify-between'>
        <div>
          <Link to="/">
          <div onClick={() => SetNavOpen(false)} className='pt-4 pl-4'>
            <svg className=" cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="103" height="44" viewBox="0 0 103 44">
        ...
        <div   onClick={() => SetNavOpen(true)} onMouseEnter={() => {
          ...
          className='bg-black w-[35vh] h-12 cursor-pointer'>
          <div ref={navGreenRef} className=' bg-[#D3FD50] w-full transition-all absolute top-0 h-0  ' >
          </div>
          <div className='flex h-full flex-col px-12 relative justify-center items-end gap-1.5 flex-cloumn '  >
            <div className='relative h-0.5 w-18 bg-white '  ></div>
            <div className='relative h-0.5 w-10 bg-white '  ></div></div>
