...
export default function Agence() {
     ...
     scrollTrigger:{
       ...
       pin:true,
        onUpdate:function(ele){
          let imageIndex=Math.floor(ele.progress*imageArray.length) 
  ...
  return (
   ...
   <div className='section-1'>
    <div ref={imagedivRef} className=' absolute h-[45vh] w-[15vw] rounded-3xl  top-[20vh] left-[62vh]  overflow-hidden  '>
